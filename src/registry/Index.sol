...
contract AddressIndex {
     ...
     */
    function changeCheck(uint256 accountVersion, address _newCheck) external isMaster {
...
contract PolyIndex is CloneFactory {
    ...
    /**
     * @dev Setup Initial things for PolyIndex, after its been deployed and can be only run once.
